...
-- JSX/HTML tags need their own captures; otherwise TSX markup looks flat.
hl("@tag", { fg = "#569cd6" })
hl("@tag.builtin", { fg = "#569cd6" })
hl("@tag.attribute", { fg = "#9cdcfe" })
hl("@tag.delimiter", { fg = "#808080" })
hl("@constructor.tsx", { fg = "#4ec9b0" })
hl("@tag.tsx", { fg = "#569cd6" })
hl("@tag.attribute.tsx", { fg = "#9cdcfe" })
hl("@tag.delimiter.tsx", { fg = "#808080" })
hl("@none.tsx", { fg = "#d4d4d4" })
