...
function M.setup(programs)
    ...
    hl.define_submap("panels", function()
        bind("B", function()
            hl.dispatch(exec("qs -p $HOME/dotfiles/.config/quickshell ipc call bottombar toggle"))
            hl.dispatch(hl.dsp.submap("reset"))
        end)
        bind("P", function()
            hl.dispatch(exec("qs -p $HOME/dotfiles/.config/quickshell ipc call workspacehud toggle"))
            hl.dispatch(hl.dsp.submap("reset"))
        end)
