...
# Aliases
alias ll='ls -al'
alias sc='grim -g "$(slurp)" ~/Pictures/Screenshots/$(date +%F_%T).png'
alias scf='grim ~/Pictures/Screenshots/$(date +%F_%T).png'
alias sce='grim -g "$(slurp)" - | swappy -f -'
alias scc='grim -g "$(slurp)" - | wl-copy'
